...
export default function Footer() {
  return (
    <footer className="fixed font-bold bottom-0  left-0 w-full z-10 ">
      ...
      <ul className="flex p-4 space-x-4 mr-0">
        <a href="https://www.facebook.com/cia.iris" className="hover:scale-110 ">
        <FaFacebook className="size-10 text-white hover:text-blue-400" />
        </a>
        
        <a href="https://www.instagram.com/webbb.pj/?next=%2F&hl=th" className="hover:scale-110 ">
